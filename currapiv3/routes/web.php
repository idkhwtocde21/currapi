...
Route::prefix('currency')->name('currency.')->group(function () {
    ...
    Route::post('/historical/data', [CurrencyController::class, 'getHistorical'])->name('historical.data');
    
    // Trend Analysis
    Route::get('/trend-analysis', [CurrencyController::class, 'trendAnalysis'])->name('trend-analysis');
    Route::post('/trend/data', [CurrencyController::class, 'getTrend'])->name('trend.data');
    
    // Multi-Currency Comparison
    Route::get('/multi-currency', [CurrencyController::class, 'multiCurrency'])->name('multi-currency');
    Route::post('/compare', [CurrencyController::class, 'compareMultiple'])->name('compare');
