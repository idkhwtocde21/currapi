    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (contentType.includes('application/json')) {
                ...
                throw new Error('Unexpected server response while fetching comparison data.');
            }
            ...
            Swal.fire({
                ...
                text: error.message || 'An error occurred while fetching comparison data. Please try again.',
                confirmButtonColor: '#374151',
                timer: 4000
            });
        } finally {
